...
(() => {
  const core = [
    ...
    ['planet_scan_profile','src/game/systems/planet-scan-profile.js'],['planet_scan_ui','src/game/ui/planet-scan-ui.js'],['landing_site_worldgen','src/game/systems/landing-site-worldgen.js'],['landing_site_scan_ui','src/game/systems/landing-site-scan-ui.js'],['planet_scan_layout_fix','src/game/ui/planet-scan-layout-fix.js'],['recruitment_dossier_ui','src/game/ui/recruitment-dossier-ui.js'],['recruitment_dossier_layout_ui','src/game/ui/recruitment-dossier-layout-ui.js'],['recruitment_coverage_ui','src/game/ui/recruitment-coverage-ui.js'],['recruitment_render_ui','src/game/ui/recruitment-render-ui.js'],['recruitment_polish_ui','src/game/ui/recruitment-polish-ui.js'],
    ...
    ['mobs','src/game/mobs.js'],['blood_wolf','src/game/mobs/blood-wolf.js'],['living_world','src/game/systems/living-world.js'],['performance_render_hooks','src/game/systems/performance-render-hooks.js'],['weather_vfx','src/game/systems/weather-vfx-system.js'],['performance_runtime_hooks','src/game/systems/performance-runtime-hooks.js'],
