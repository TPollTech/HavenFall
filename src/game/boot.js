...
(() => {
  const core = [
    ...
    ['asset_manifest','assets/manifest.js'],['fire_vfx_manifest','src/game/ui/fire-vfx-manifest.js'],['asset_audit','src/game/asset-audit.js'],['creature_sprite_sheet','src/game/creature-sprite-sheet.js'],
    ['game_setup','src/game/game-setup.js'],['colonist_generation','src/game/colonist-generation.js'],['research_system','src/game/research-system.js'],['research_defs','src/game/research-defs.js'],['colonist_mechanics','src/game/colonist-mechanics.js'],['screen_manager','src/game/screen-manager.js'],['world_generator','src/game/world-generator.js'],
    ...
    ['mobs','src/game/mobs.js'],['blood_wolf','src/game/mobs/blood-wolf.js'],['creature_renderer','src/game/creature-renderer.js'],['mob_interactions','src/game/mob-interactions.js'],['ui_icon_safety','src/game/ui/icon-safety.js'],['research_overlay','src/game/ui/research-overlay.js'],['colonist_modal','src/game/ui/colonist-modal.js'],['ui_manager','src/game/ui/ui-manager.js'],['pause_menu','src/game/ui/pause-menu.js'],
    ['tab_crafting','src/game/ui/tab-crafting.js'],['tab_zones','src/game/ui/tab-zones.js'],['tab_colonists','src/game/ui/tab-colonists.js'],['tab_tasks','src/game/ui/tab-tasks.js'],['tab_orders','src/game/ui/tab-orders.js'],['tab_schedule','src/game/ui/tab-schedule.js'],['tab_events','src/game/ui/tab-events.js'],['dock_tab_router','src/game/ui/dock-tab-router.js'],['save_load','src/game/save-load.js'],['game_loop','src/game/game-loop.js'],['event_listeners','src/game/event-listeners.js'],
    ['alpha_construction_system','src/game/alpha-construction-system.js'],['alpha_render_collision_system','src/game/alpha-render-collision-system.js'],['colonist_pathing_system','src/game/systems/colonist-pathing-system.js'],['wall_door_renderer','src/game/rendering/wall-door-renderer.js'],['task_reservation_system','src/game/systems/task-reservation-system.js']
