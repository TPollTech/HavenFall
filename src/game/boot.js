...
(() => {
  const core = [
    ...
    ['alpha_construction_system','src/game/alpha-construction-system.js'],['alpha_render_collision_system','src/game/alpha-render-collision-system.js'],['alpha_colonist_pathing_hotfix','src/game/alpha-colonist-pathing-hotfix.js'],['alpha_wall_door_solid_visual','src/game/alpha-wall-door-solid-visual.js'],['alpha_lock_system','src/game/alpha-lock-system.js']
