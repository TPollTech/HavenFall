...
(() => {
  ...
  function install() {
    ...
    window.GameSystems?.registerBeforeColonistUpdate?.('alpha-door-path-repair', repairStalledPath, { order: 2 });
    window.HavenfallColonistPathingHotfix = 'door-aware-pathing';
    console.info('[Alpha Pathing] Colonos agora planejam caminho por portas e abrem automaticamente.');
  }
