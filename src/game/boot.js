...
(() => {
  const core = [
    ...
    ['mobs','src/game/mobs.js'],['blood_wolf','src/game/mobs/blood-wolf.js'],['living_world','src/game/systems/living-world.js'],
