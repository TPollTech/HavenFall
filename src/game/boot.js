...
(() => {
  const core = [
    ...
    ['renderer','src/game/renderer.js'],['performance_optimizer','src/game/rendering/performance-optimizer.js'],['fog_of_war_render_hook','src/game/ui/fog-of-war-render-hook.js'],['geology_backdrop_render_hook','src/game/ui/geology-backdrop-render-hook.js'],['geology_object_render_guard','src/game/ui/geology-object-render-guard.js'],['fire_vfx_render_hooks','src/game/ui/fire-vfx-render-hooks.js'],['canvas_input_building','src/game/canvas-input-building.js'],['orders_canvas_input_hook','src/game/ui/orders-canvas-input-hook.js'],['hud_ui','src/game/ui/hud-ui.js'],
    ['planet_scan_profile','src/game/systems/planet-scan-profile.js'],['planet_scan_ui','src/game/ui/planet-scan-ui.js'],['landing_site_worldgen','src/game/systems/landing-site-worldgen.js'],['landing_site_scan_ui','src/game/systems/landing-site-scan-ui.js'],['landing_site_scan_polish','src/game/systems/landing-site-scan-polish.js'],['recruitment_dossier_ui','src/game/ui/recruitment-dossier-ui.js'],['recruitment_dossier_layout_ui','src/game/ui/recruitment-dossier-layout-ui.js'],['recruitment_coverage_ui','src/game/ui/recruitment-coverage-ui.js'],['recruitment_render_ui','src/game/ui/recruitment-render-ui.js'],['recruitment_polish_ui','src/game/ui/recruitment-polish-ui.js'],
