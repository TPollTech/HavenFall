...
(() => {
  const core = [
    ...
    ['mobs','src/game/mobs.js'],['blood_wolf','src/game/mobs/blood-wolf.js'],
    ...
    ['workstation_core','src/game/rendering/workstations/workstation-core.js'],['workstation_style','src/game/rendering/workstations/workstation-style.js'],['workstation_renderer','src/game/rendering/workstations/workstation-renderer.js'],
    ['mob_interactions','src/game/mob-interactions.js'],['ui_icon_safety','src/game/ui/icon-safety.js'],['research_overlay','src/game/ui/research-overlay.js'],['colonist_modal','src/game/ui/colonist-modal.js'],['ui_manager','src/game/ui/ui-manager.js'],['pause_menu','src/game/ui/pause-menu.js'],
