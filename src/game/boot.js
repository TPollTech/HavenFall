...
(() => {
  const core = [
    ...
    ['mob_interactions','src/game/mob-interactions.js'],['ui_icon_safety','src/game/ui/icon-safety.js'],['research_overlay','src/game/ui/research-overlay.js'],['colonist_modal','src/game/ui/colonist-modal.js'],['inspection_panel','src/game/ui/inspection-panel.js'],['ui_manager','src/game/ui/ui-manager.js'],['pause_menu','src/game/ui/pause-menu.js'],['performance_settings_ui','src/game/ui/performance-settings-ui.js'],['performance_settings_backfix','src/game/ui/performance-settings-backfix.js'],
