...
(() => {
  const core = [
    ...
    ['planet_scan_profile','src/game/systems/planet-scan-profile.js'],['planet_scan_ui','src/game/ui/planet-scan-ui.js'],['landing_site_worldgen','src/game/systems/landing-site-worldgen.js'],['landing_site_scan_ui','src/game/systems/landing-site-scan-ui.js'],['landing_site_scan_polish','src/game/systems/landing-site-scan-polish.js'],['planet_scan_layout_fix','src/game/ui/planet-scan-layout-fix.js'],['recruitment_dossier_ui','src/game/ui/recruitment-dossier-ui.js'],['recruitment_dossier_layout_ui','src/game/ui/recruitment-dossier-layout-ui.js'],['recruitment_coverage_ui','src/game/ui/recruitment-coverage-ui.js'],['recruitment_render_ui','src/game/ui/recruitment-render-ui.js'],['recruitment_polish_ui','src/game/ui/recruitment-polish-ui.js'],
    ...
    ['mob_interactions','src/game/mob-interactions.js'],['ui_icon_safety','src/game/ui/icon-safety.js'],['research_overlay','src/game/ui/research-overlay.js'],['colonist_modal','src/game/ui/colonist-modal.js'],['inspection_panel','src/game/ui/inspection-panel.js'],['inspection_input_hook','src/game/ui/inspection-input-hook.js'],['ui_manager','src/game/ui/ui-manager.js'],['pause_menu','src/game/ui/pause-menu.js'],['performance_settings_ui','src/game/ui/performance-settings-ui.js'],['performance_settings_backfix','src/game/ui/performance-settings-backfix.js'],
    ['tab_crafting','src/game/ui/tab-crafting.js'],['tab_zones','src/game/ui/tab-zones.js'],['tab_colonists','src/game/ui/tab-colonists.js'],['tab_tasks','src/game/ui/tab-tasks.js'],['tab_orders','src/game/ui/tab-orders.js'],['tab_schedule','src/game/ui/tab-schedule.js'],['tab_events','src/game/ui/tab-events.js'],['dock_tab_router','src/game/ui/dock-tab-router.js'],['dock_panel_state_fix','src/game/ui/dock-panel-state-fix.js'],['save_load','src/game/save-load.js'],['runtime_save_ui','src/game/runtime/runtime-save-ui.js'],['game_loop','src/game/game-loop.js'],['event_listeners','src/game/event-listeners.js'],['world_travel_system','src/game/systems/world-travel-system.js'],['world_map_ui','src/game/ui/world-map-ui.js'],
    ['construction_system','src/game/systems/construction-system.js'],['render_collision_system','src/game/systems/render-collision-system.js'],['colonist_pathing_system','src/game/systems/colonist-pathing-system.js'],['wall_door_renderer','src/game/rendering/wall-door-renderer.js'],['task_reservation_system','src/game/systems/task-reservation-system.js'],['manual_control','src/game/systems/manual-control-system.js'],['escape_action_router','src/game/systems/escape-action-router.js'],['performance_hotfixes','src/game/systems/performance-hotfixes.js'],['loop_performance_hotfix','src/game/systems/loop-performance-hotfix.js']
